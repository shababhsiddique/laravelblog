                    ...
                    <tbody>
                        <?php foreach ($deletedArticles as $anArticle) { ?>
                            <tr>
                                ...
                                <td class="td-actions text-right">
                                    <a href="{{url('/admin/changestatus-article/rec/'.$anArticle->article_id)}}" type="button" rel="tooltip" title="" class="btn btn-success btn-sm" data-original-title="Undo Delete">
            ...
            <div class="card-content table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($allArticles as $anArticle) { ?>
                            <tr>
                                <td><strong>{{$anArticle->article_title}}</strong></td>
                                <td class="text-left">{{substr(strip_tags($anArticle->article_body),0,200)}}...</td>
                            </tr>
                        <?php } ?>                        
                    </tbody>
                </table>
